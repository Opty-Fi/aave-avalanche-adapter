...
const NETWORK = (process.env.NETWORK || "hardhat") as eAvalancheNetwork;

// Prevent to load scripts before compilation and typechain
if (!SKIP_LOAD) {
  ["avalanche"].forEach(folder => {
...
const getCommonNetworkConfig = (networkName: eAvalancheNetwork): NetworkUserConfig | undefined => ({
